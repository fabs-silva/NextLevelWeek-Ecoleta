...
const CreatePoint = () => {
    ...
    useEffect(() =>{
        ...
        }, position => setInitialPosition([-23.550164466, -46.633664132])
    )}, []);
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select id="uf" value={selectedUf} name="uf" onChange={handleSelectUf}>
                        ...
                        <div className="field">
                            ...
                            <select  id="city" value={selectedCity} onChange={handleSelectCity}>
